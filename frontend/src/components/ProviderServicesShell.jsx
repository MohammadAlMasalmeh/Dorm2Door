...
/**
 * Shared chrome for provider dashboard: overview (/services), stats (/services/stats), edit (/my-services).
 */
export default function ProviderServicesShell({ children }) {
  return (
    <div className="services-page" style={{ background: FIGMA_BG, minHeight: '100vh' }}>
      <aside className="services-sidebar">
        <nav className="services-sidebar-nav">
          ...
          <NavLink to="/services/stats" className={({ isActive }) => `services-sidebar-item${isActive ? ' active' : ''}`}>
            <StatsIcon />
            <span>Stats</span>
          </NavLink>
        </nav>
